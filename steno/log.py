...
from config import CONFIG_DIR, PLATFORM
...
class Logger:
    ...
    def setup_platform_handler(self):
        ...
        try:
            if PLATFORM == 'linux':
                from log_dbus import DbusNotificationHandler
                handler_class = DbusNotificationHandler
            elif PLATFORM == 'mac':
                from log_osx import OSXNotificationHandler
                handler_class = OSXNotificationHandler
            elif PLATFORM == 'win':
                from log_plyer import PlyerNotificationHandler
